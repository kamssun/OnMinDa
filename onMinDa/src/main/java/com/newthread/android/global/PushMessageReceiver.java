package com.newthread.android.global;
...
//			responseIntent = new Intent(OnCampusActivity.ACTION_MESSAGE);
//			responseIntent.putExtra(OnCampusActivity.EXTRA_MESSAGE, message);
//			responseIntent.setClass(context, OnCampusActivity.class);
...
//					.show();
		...
		//可选。通知用户点击事件处理
			...
			aIntent.setClass(context, OnCampusActivity.class);
